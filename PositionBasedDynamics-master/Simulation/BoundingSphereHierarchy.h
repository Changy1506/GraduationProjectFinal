...
namespace PBD
{
	...
	public:
		...
		static void t_single(PointCloudBSH const& b1,TraversalCallback func);
		static void t_single(PointCloudBSH const& b1, const unsigned int node_index1,const unsigned int node_index2, TraversalCallback func);
